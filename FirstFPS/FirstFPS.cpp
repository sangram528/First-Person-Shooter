...
int main()
{
    ...
    while (1) {
        ...
        for (int x = 0; x < nScreenWidth; x++) {
            // Projected ray angle into world space
            ...
            while (!bHitWall && fDistanceToWall < fDepth) {
                ...
                if (nTestX < 0 || nTestX >= nMapWidth || nTestY < 0 || nTestY >= nMapHeight) {
                    bHitWall = true;
                    fDistanceToWall = fDepth;  // max depth
                }
                else {
                    // Ray inbounds
            ...
            if (bBoundary) nShade = ' ';  // black it out if boundary

            // Render each column of the screen
